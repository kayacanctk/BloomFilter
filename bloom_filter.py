"""Bloom Filter runs performance tests across English words, DNA sequences and IDs"""
import math
import hashlib
class BloomFilter:
    """
    ...
    def __init__(self, expected_items: int, fp_rate: float):
        """Handles data types constraints"""
    ...
    def add(self, item):
        """
        Inserts an item into the Bloom Filter setting the hashed indices to True.
        """
